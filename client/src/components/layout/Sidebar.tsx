...
export function Sidebar() {
  ...
  return (
    <aside
      className={`fixed top-0 left-0 h-screen bg-slate-950 border-r border-slate-800 flex flex-col transition-all duration-300 z-30 ${
    ...
    >
      ...
      <button
        ...
        className="h-12 flex items-center justify-center border-t border-slate-800 text-slate-400 hover:text-slate-200 hover:bg-slate-800 transition-colors"
      >
        <svg
